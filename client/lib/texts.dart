...
class my_texts {
 ...
 connectedToServer="متصل بالخادم" ;
  ...
  endContact="end Contact";
     ...
     explaneText= Text("The details you enter now will be stored locally. Only when an SOS call is made the application will use the data. The data can be changed in any time",
      style: GoogleFonts.abel(fontSize: 16,fontWeight: FontWeight.w800,color: Colors.black),);
