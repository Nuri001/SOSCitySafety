...
bool signinEmit=false;
  ...
  await GetAddressFromLatLong(c1) ;
   ...
   await GetAddressFromLatLong(c3) ;
    ...
    Client c5=Client(userName: "test5",
        phone: "0545500088",
        lat: 32.109300,
        long: 34.855499,
        socketId:"5",
        dateTime: DateTime.now());
    await GetAddressFromLatLong(c5) ;
...
/////////////////////////////////////////////
  ...
  Widget statusContainer(Client client)=>Container(
    ...
    //  color: Colors.white,
      child: Center(
        child: Stack(children: [
          if(client.STATUS==1) Text(my_texts.clientConnected, style:const TextStyle(
        fontSize:20,
  ...
  Widget clientContainer(Client client)=>Stack(children: [
    ...
    Align(alignment: const Alignment(-1,0.3),child: Container(
      height: 370,
      width: 350,
     // color: Colors.red,
      child: Stack(children: [
        Align(alignment: const Alignment(0,-1),child: addresDefaultTextStyle(client)),
        Align(alignment: const Alignment(0,1),child: mapContainer(client.lat,client.long)),
